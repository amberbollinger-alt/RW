...
export default function RootFourValley({ go, initialLessonKey, onLessonChange }) {
  ...
  return <main className="root-four-valley"><div className={`r4-landscape r4-stage-${Math.floor(activeIndex / 5)}`} aria-hidden="true"><img src="/root-four-reservoir-valley.png" alt="" /><div className="r4-landscape-shade" /></div>
