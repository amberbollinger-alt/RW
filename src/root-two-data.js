const chapterOneLessons = [
  {
    ...
    story: [
      ...
      {
        type: "narration",
        text: "A repair technician named Mara kneels beside the press, listens once, removes a narrow side panel, and resets a slipped safety catch. The machine hums back to life in eleven minutes. Mara writes seventy-five dollars on the invoice.",
      },
      {
        type: "dialogue",
        speaker: "Eli",
    ...
    check: {
      prompt: "What did the laundress receive beyond eleven minutes of Mara’s time?",
      options: [
        {
  ...
  },
  {
    ...
    opening:
      "Mara invites Ivy and Eli to walk with her to the next repair. Eli is still looking at the invoice, but now he is curious about everything the number failed to show.",
    story: [
      {
        type: "narration",
        text: "On the way, Mara describes her first year in the trade. She carried tools for a senior technician and was not permitted to diagnose dangerous equipment alone. She learned electrical safety, studied diagrams at night, ruined inexpensive practice parts, and spent months recognizing which sounds meant wear, blockage, loose alignment, or immediate danger.",
      },
      {
        type: "dialogue",
        speaker: "Ivy",
      ...
      {
        type: "narration",
        text: "Mara nods. Her next customer runs a small bakery. One oven is heating unevenly, and the baker has already replaced a sensor without solving the problem. Mara checks the repair history, watches one heating cycle, and notices a faint color change near a connection. She shuts the oven down before opening it. The wire beneath the panel has begun to burn.",
      },
      {
        type: "narration",
        text: "Eli realizes he would not have noticed the color change. Even if he had, he would not have known whether it meant dust, age, or danger. Mara’s value is not simply possessing information. It is retrieving the right knowledge in the right moment and accepting responsibility for what happens next.",
      },
      {
        type: "sage",
        speaker: "Sage",
      ...
      {
        type: "narration",
        text: "The baker cancels the afternoon batch while the connection is replaced. That costs money today. Continuing to use the oven might have cost much more—or harmed someone. The accumulated knowledge inside Mara’s hour does not remove every cost. It changes which cost becomes necessary.",
      },
    ],
    concept: {
    ...
    check: {
      prompt: "Why did Mara’s experience matter during the bakery repair?",
      options: [
        {
  ...
  },
  {
    ...
    story: [
      {
        type: "narration",
        text: "In a quiet courtyard, the district posts the previous day’s payments. The crane operator earned emergency pay. Mara earned two repair fees. The musicians earned different amounts, and one earned nothing from the community performance. A caregiver who stayed beside an ill neighbor through the storm does not appear on the board at all.",
      },
      {
        type: "dialogue",
        speaker: "Eli",
      ...
      {
        type: "narration",
        text: "They visit Mara one final time. She tells Eli that a high invoice can never make her more human than the laundress who pays it. A quiet month does not erase her knowledge. And if a customer cannot afford a necessary repair, the need may remain real even when no transaction can occur.",
      },
      {
        type: "sage",
        speaker: "Sage",
